...
export default class BaiTapRenderDanhSachPhim extends Component {
    ...
    renderPhimWithMap = () => {
        ...
        //     paddingTop:'10px'
        // }
        return this.mangPhim.map((mangPhim, index) => {
            return <div className="col-4" key={index} style={{
                marginBottom:'30px'
            }}>
                <div className="card text-dark">
                    {/* <img className={`card-img-top ${style.hinhAnhPhim}`} src={mangPhim.hinhAnh} alt /> */}
                    <img style ={
                        {
                        height: '200px',
                        width: 'auto',
                    ...
                    } className={`card-img-top`} src={mangPhim.hinhAnh} alt />
                    <div className="card-body">
                        <h4 className="card-title" style ={{ height:'50px'}}>{mangPhim.tenPhim}</h4>
                        <p className="card-text">{mangPhim.moTa.length >100 ? <span>{mangPhim.moTa.substr(0,70)} ... </span> : <span>{mangPhim.moTa}</span>}</p>
                    </div>
                </div>
            </div>
        })
